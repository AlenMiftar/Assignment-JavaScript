...
// HJÄLP med skillnad på alert() och prompt()
// alert() visar endast en ruta med ett meddelande till usern
alert("text meddelande här...");

// prompt() visar en ruta med ett meddelande OCH tar emot en input från usern
// så att vi kan spara input i en variabel, i exemplet nedan sparas input i
// variabeln text
const text = prompt("text meddelande här");
// så vi kan tex logga ut variabeln text för att see värdet
console.log(text);
...
// startar funktionen asUserName som i sin tur triggar menu() funktionen
askUserName();
